...
class SteeringNode(Node):
    ...
    def worker_loop(self):
        ...
        while rclpy.ok():
            ...
            # ================== TBD ============================
            cv_image = ... # Decode the incoming compressed image into a CV2 image
            if cv_image is None:
                continue

            # Preprocess
            img_tensor = ... # Preprocess the image into a PyTorch tensor
            )
            # ================== TBD END ============================
    ...
    def publish_cmd(self):
        ...
        twist = ... # Create a new Twist message
        ...
        if mode == "track":
            ...
            ang_vel = ... # get the value from the node parameter under the name 'uturn_angular_vel'
            twist.linear.x = ...
            twist.angular.z = ...
